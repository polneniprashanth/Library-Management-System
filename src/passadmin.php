...
<?php
    ...
    if(isset($_POST['Submit'])){
        ...
        if($roww["password"]!=$_POST["pass"]){
            header("Location:http://upgradetopro.great-site.net/LMS/passadmin.php?msg1=incorrect password!!!");
            echo "incorrect password";
        }
        if($_POST["npass"]!=$_POST["cnpass"]){
            header("Location:http://upgradetopro.great-site.net/LMS/passadmin.php?msg1=Passwords didn't match!!!");
            echo "Passwords didn't match"; 
        }
        mysqli_query($conn,"UPDATE admin set password='" . $_POST["npass"] . "' WHERE email='" . $id . "'");
        header("Location:http://upgradetopro.great-site.net/LMS/adminhome.php?msg1=Password changed successfully!");
    }
?>
<!DOCTYPE html>
<html lang="en">
